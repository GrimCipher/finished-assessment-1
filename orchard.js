...
for (let i = 0; i < fujiAcres.length; i++) {
    fujiTons.push(fujiAcres[i] * acresYield)
    galaTons.push(galaAcres[i] * acresYield)
    pinkTons.push(pinkAcres[i] * acresYield)
}
...
let poundsInATon = 2000

for (let i = 0; i < fujiAcres.length; i++) {
    fujiPounds += fujiAcres[i] * acresYield * poundsInATon
    galaPounds += galaAcres[i] * acresYield * poundsInATon
    pinkPounds += pinkAcres[i] * acresYield * poundsInATon
}
...
for (let i = 0; i < fujiAcres.length; i++) {
    fujiProfit += fujiAcres[i] * acresYield * poundsInATon * fujiPrice
    galaProfit += galaAcres[i] * acresYield * poundsInATon * galaPrice
    pinkProfit += pinkAcres[i] * acresYield * poundsInATon * pinkPrice
}
